      ...
      <div className='footer-container'>
        <nav className="footer-navs">
          <ul className='footer-nav'>
            ...
            <li>REPORT UNAUTHORIZED <br /> TRANSACTION</li>
        ...
        <div className="footer-sub-nav">
          <img src="/assests/logo.png" alt="" className='nav__logo' />
          <p>APNA Bank Group websites</p>
          <i className='fa-solid fa-caret-down'></i>
          <select name="" id="">
            <option value="" defaultValue={'seclect website'}>select website</option>
          </select>
          <p>APNA Bank Country Website</p>
          <i className='fa-solid fa-caret-down'></i>
          <select name="" id="">
            <option value="" defaultValue={'seclect website'}>select website</option>
          </select>
        ...
        <div className="pg-footer">
          <footer className="footer">
            <svg className="footer-wave-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 100" preserveAspectRatio="none">
              {/* <path className="footer-wave-path" d="M951.8,100c125,0,288.3-45,348.2-64V0H0v44c3.7-1,7.3-1.9,11-2.9C80.7,22,151.7,10.8,223.5,6.3C276.7,2.9,330,4,383,9.8 c52.2,5.7,103.3,16.2,153.4,32.8C623.9,71.3,726.8,100,851.8,100z"></path> */}
            </svg>
            ...
            <div className="footer-copyright">
              <div className="footer-copyright-wrapper">
                <p className="footer-copyright-text">
                  <a className="footer-copyright-link" href="#" target="_self"> ©{new Date().getFullYear()} | ApnaBank | All rights reserved. </a>
                </p>
              </div>
            </div>
          </footer>

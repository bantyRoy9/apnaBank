    ...
    <>
      <div className='footer-container'>
        ...
        <div className="footer-sub-nav">
          <img src="/assests/logo1.png" alt="" className='nav__logo' />
            ...
            <div class="footer-copyright">
              <div class="footer-copyright-wrapper">
                <p class="footer-copyright-text">
                  <a class="footer-copyright-link" href="#" target="_self"> ©{new Date().getFullYear()} | GoHoardings | All rights reserved. </a>
                </p>
              </div>
            </div>
          </footer>
